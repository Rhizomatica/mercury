...
/* How long past one ACK timeout plus one frame the IRS keeps trusting the
 * ISS's "more is queued" before asking for the floor anyway: covers the
 * retry stagger and scheduling jitter (see peer_still_sending in arq_fsm.c). */
